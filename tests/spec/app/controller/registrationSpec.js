...
(function() {
  var Registration, actions, appdir, basedir, config, configdir, modeldir, mongoose, registrationModel, request;
  ...
  describe("registration", function() {
    it('should respond with hello world', function(done) {
      return request.get(config.host + "/api/event/registrations/helloworld", function(error, response, body) {
        var link1, link2;
